  ...
  return (
    <section className="mx-auto w-full max-w-4xl px-6 pb-16 pt-8">
      <article className="rounded-card bg-white/95 p-8 shadow-lg ring-1 ring-primary/10 backdrop-blur-sm">
        ...
        {isVerified ? (
          <>
            <p className="mt-2 text-sm text-primary/80">Your account is already verified.</p>
            <p className="mt-4 rounded-card bg-success/20 px-4 py-3 text-sm font-semibold text-primary ring-1 ring-success/40">
              Your document is verified.
            </p>
            <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-success/20 px-4 py-2 text-sm font-semibold text-primary ring-1 ring-success/40">
          ...
          <>
            ...
            <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={!documentName || isSubmitting}
